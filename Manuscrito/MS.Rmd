...
Los ecosistemas naturales están compuestos por una gran diversidad de especies y sus interacciones. Una forma de abordar esta diversidad es mediante el concepto de red trófica, que describe la red de interacciones ecológicas (presa-depredador) que ocurren con más frecuencia entre especies en un ecosistema [@Pascual2005]. Comprender la relación entre la complejidad y la estabilidad de los ecosistemas es de vital importancia para el mantenimiento y la conservación de todos los servicios naturales que brindan los ecosistemas [@Montoya2003a].

El estudio de la complejidad y la estabilidad en redes tróficas utilizando la teoría de redes comenzó en la década de 1970 con el análisis de comunidades terrestres y dulceacuícolas [@May1973; @Cohen1978; @Briand1987]. Durante esta época, R.M. May sugirió, de manera teórica, una relación entre complejidad, analizada mediante la conectividad ($C = L/S^2$ donde $L$ es el número de interacciones y $S$ el número de especies), y estabilidad en redes ecológicas: a mayor conectividad, menor estabilidad [@May1973]. Así se generó una contradicción entre ecosistemas muy diversos [@Paine1966; @Naeem1997] y la hipótesis de May. Con el advenimiento de redes tróficas empíricas de mayor resolución (i.e. mayor representación de especies biológicas que de grupos funcionales agregados) y, por ende, complejidad, así como nuevas metodologías para estimar la estabilidad, el debate complejidad-estabilidad tomó relevancia como una línea de investigación en si misma en ecología [@McCann2000; @Allesina2015; @Namba2015; @Jacquet2016; @Mougi2022].

El debate complejidad-estabilidad sigue en discusión en la actualidad, hecho que se sustenta debido a resultados contradictorios [@Landi2018a] y, sobre todo, a la multidimensionalidad del concepto de estabilidad [@Donohue2016; @Dominguez-Garcia2019]. El análisis de estabilidad en redes tróficas puede abordarse de manera directa e indirecta. En este último caso, existen ciertas propiedades estructurales de la red que se utilizan como indicadores de estabilidad ya que describen dimensiones de la misma, como la resistencia ante perturbaciones. La modularidad es una propiedad que indica cuán fuerte es la cohesión, medida en cantidad de interacciones, entre especies de un mismo módulo o subgrupo de especies con respecto a otros módulos [@Krause2003]. Se espera que redes tróficas más modulares, es decir con mayor cohesión en sus módulos, sean más resistentes a perturbaciones debido a que los módulos actuarían previniendo la dispersión al resto de las especies de la red [@Grilli2016].
Por otro lado, el índice 'Quasi-Sign Stability' (QSS) es una propiedad que analiza la estabilidad de manera directa. El índice da cuenta de la estabilidad local de la red revelando la amplificación o no de pequeñas perturbaciones cerca del punto de equilibrio [@Allesina2008].
...
@Windsor2023 sugiere investigar las relaciones entre complejidad y estabilidad a través de los gradientes de complejidad de la red (es decir, de uno a múltiples tipos de interacciones), así como a través de diferentes escalas (es decir, de local a regional), puede ser posible mejorar nuestra comprensión.


El presente trabajo tiene como objetivo general estudiar la estabilidad y la relación complejidad-estabilidad en redes tróficas empíricas. Para esto analizamos dos propiedades de estabilidad, modularidad e índice QSS, que evaluamos de manera general y y particularmente por tipo de ecosistema (dulceacuícola, marino, terrestre).
...
## Análisis complejidad y estabilidad
