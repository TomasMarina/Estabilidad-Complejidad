...
En este trabajo describimos, por primera vez, la multidimensionalidad de la estabilidad utilizando una base de datos de más de 300 redes tróficas empíricas cubriendo un rango amplio de complejidad en distintos tipos de ecosistemas. Los resultados muestran diferencias importantes en la estabilidad de las redes según el ecosistema. En este sentido, las redes tróficas terrestres y las marinas presentan diferencias significativas considerando indicadores indirectos (modularidad) y directos de estabilidad (índice QSS).


ambos indicadores de estabilidad, directos e indirectos, sugieren que las redes tróficas terrestres y las marinas presentan diferencias en su 
